...
public enum MatingAlgorithm {
    ...
    private final BiFunction<Parents, GeneticAlgorithmContext, Children> algorithm;

    MatingAlgorithm(BiFunction<Parents, GeneticAlgorithmContext, Children> algorithm) {
        this.algorithm = algorithm;
    }

    Children mate(Parents parents, GeneticAlgorithmContext context) {
        return algorithm.apply(parents, context);
    }
}
